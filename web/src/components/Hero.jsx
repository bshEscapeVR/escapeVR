                ...
                */}
                ...
                <div className="flex flex-col md:flex-row gap-4 justify-center items-center mb-16">
                    ...
                    <button
                        ...
                        className="group/trailer bg-white hover:bg-white/90 backdrop-blur-md text-brand-primary px-8 py-2.5 rounded-full font-medium text-base border border-white/20 transition-all flex items-center gap-2 w-full md:w-auto justify-center hover:scale-105"
                    >
